...
def main():
    ...
    parser.add_argument('--pre_dataset', default='Yelp/v3/pretrain/', help='Filename')
    parser.add_argument('--fine_dataset', default='Yelp/v3/finetune/', help='Filename')
    parser.add_argument('--pre_train', default=True, help='train or not')
    ...
    load_path = 'F:/mm-data/Yelp/v6/finetune/540.pth'
